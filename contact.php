...
?>
       ...
       <div class="row">
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                    UIET<br>CSJM UNIVERSITY<br>
					KANPUR- 208024<br>
                </p>
                <p><i class="fa fa-phone"></i>
                <abbr title="whatsapp">whatsapp</abbr>: 6306286773,8573803911</p>
                </p>
                <ul class="list-unstyled list-inline list-social-icons">
                    <li>
                        <a href="https://www.facebook.com/kumar.manish12jan/" target="_blank"><i class="fa fa-facebook-square fa-2x">
                            Manish
                        </i></a>
                    </li>
                    <li>
                        <a href="https://www.facebook.com/mohdsadiq987/" target="_blank"><i class="fa fa-facebook-square fa-2x">
                            Sadique
                        </i></a>
                    </li>
         ...
         <footer class="copy" style="float: center; margin-top: 10px; margin-left: 300px;"> &copy; MANISH KUMAR KUSHWAHA | MOHD. SADIQUE </footer>
